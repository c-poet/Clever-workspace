...
public abstract class ModuleHolder {
    ...
    public static Module getModule(String packageName) {
        ...
        cn.cpoet.workspace.api.annotation.Module moduleAnnotation = getModuleAnnotation(packageName);
    ...
    private static Module createModule(String packageName, cn.cpoet.workspace.api.annotation.Module moduleAnnotation) {
        if (moduleAnnotation == null) {
            return null;
        }
        ...
        cn.cpoet.workspace.api.annotation.Rewrite rewriteBeanAnnotation = moduleAnnotation.rewrite();
        ...
        cn.cpoet.workspace.api.annotation.Mapping mappingAnnotation = moduleAnnotation.mapping();
     ...
     * @return 模块注解信息
     */
    private static cn.cpoet.workspace.api.annotation.Module getModuleAnnotation(String packageName) {
        Package pck = Package.getPackage(packageName);
        if (pck == null) {
            return null;
        }
        return pck.getAnnotation(cn.cpoet.workspace.api.annotation.Module.class);
    }
     ...
     * @return 模块注解信息
     */
    private static cn.cpoet.workspace.api.annotation.Module getModuleAnnotationByCt(String packageName) {
        ...
        try (InputStream in = classLoader.getResourceAsStream(packageInfoFile)) {
            ...
            return (cn.cpoet.workspace.api.annotation.Module) ctClass.getAnnotation(cn.cpoet.workspace.api.annotation.Module.class);
        } catch (Exception e) {
